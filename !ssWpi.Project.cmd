...
@REM echo Backing up originals...
@REM cd "%~dp0"
@REM if exist "%sc%\originals" goto Cleaning
@REM md "%sc%\originals\%EditorPath%"
@REM md "%sc%\originals\%ssPIPath%"
@REM copy "%sc%\*.au3" "%sc%\originals" /y >nul:
@REM copy "%sc%\*.iss" "%sc%\originals" /y >nul:
@REM copy "%sc%\*.app" "%sc%\originals" /y >nul:
@REM copy "%sc%\%EditorPath%\*.au3" "%sc%\originals\%EditorPath%" /y >nul:
@REM copy "%sc%\%EditorPath%\*.app" "%sc%\originals\%EditorPath%" /y >nul:
@REM copy "%sc%\%ssPIPath%\*.au3" "%sc%\originals\%ssPIPath%" /y >nul:
@REM copy "%sc%\%ssPIPath%\*.ini" "%sc%\originals\%ssPIPath%" /y >nul:
@REM copy "%sc%\SetupS-*.htm" "%sc%\originals" /y >nul:
